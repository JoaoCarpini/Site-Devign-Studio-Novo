    ...
    <div className="grid gap-4 lg:grid-cols-6">
      {processSteps.map((step, index) => (
        <Reveal key={step.title} delay={index * 0.05} className="relative">
          <div className="h-full rounded-[1.4rem] border border-white/10 bg-white/[0.055] p-5 sm:backdrop-blur-xl transition duration-300 hover:border-violet-400/40 hover:bg-white/[0.08]">
