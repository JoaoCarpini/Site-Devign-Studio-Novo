      ...
      {technologies.map((technology, index) => {
        ...
        return (
          <div
            key={technology.name}
            className={cn(
              'group relative min-w-0 overflow-hidden rounded-2xl border border-white/10 bg-white/[0.055] p-4 transition duration-300 hover:-translate-y-1 hover:border-violet-400/35 hover:bg-white/[0.085] sm:p-5 sm:backdrop-blur-xl',
