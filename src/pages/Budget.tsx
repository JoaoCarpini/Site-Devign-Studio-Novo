...
export default function Budget() {
  return (
    <section className="relative max-w-full overflow-x-hidden pt-24 sm:pt-32 lg:pt-36">
      ...
      <div className="container-premium relative mx-auto grid max-w-7xl gap-5 pb-12 pt-4 sm:gap-8 sm:pb-20 lg:grid-cols-[0.85fr_1.15fr] lg:items-start lg:gap-10 lg:pb-28">
          ...
          <div className="mt-5 grid gap-2.5 sm:grid-cols-3 lg:mt-8 lg:grid-cols-1">
            {signals.map((item) => {
              ...
              return (
                <div
                  key={item.label}
                  className="flex min-h-12 items-center gap-3 rounded-2xl border border-white/10 bg-white/[0.045] px-3.5 py-3 text-sm font-semibold text-frost shadow-[0_14px_44px_rgba(5,5,9,0.2)] backdrop-blur-lg"
                >
