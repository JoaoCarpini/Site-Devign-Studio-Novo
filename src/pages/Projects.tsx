  ...
  return (
    <>
      <section className="relative overflow-hidden pt-28 sm:pt-40">
        <AuroraBackground />
        <div className="container-premium relative grid gap-8 pb-14 pt-6 sm:gap-12 sm:pb-20 sm:pt-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:pb-28">
          <Reveal>
          ...
          <Reveal delay={0.08} className="rounded-[1.45rem] border border-white/10 bg-white/[0.055] p-5 shadow-premium backdrop-blur-2xl sm:rounded-[2rem] sm:p-6">
      ...
      <section className="section-band pt-0">
        <div className="container-premium">
          <Reveal className="mb-14">
            <div className="relative overflow-hidden rounded-[1.45rem] border border-white/10 bg-[linear-gradient(160deg,rgba(141,92,255,0.12),rgba(255,255,255,0.04)_42%,rgba(5,5,9,0.2))] p-5 shadow-premium backdrop-blur-2xl sm:rounded-[2rem] sm:p-10 lg:grid lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12">
              <div className="pointer-events-none absolute -right-20 -top-20 h-56 w-56 rounded-full bg-violet-500/15 blur-3xl" />
              <div>
                <span className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/[0.05] px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-violet-300">
                  <FileText className="h-3.5 w-3.5" />
                  Company deck
                </span>
                <h2 className="mt-5 max-w-2xl text-[1.8rem] font-semibold leading-tight text-frost sm:text-4xl">
              ...
              <div className="mt-6 rounded-[1.35rem] border border-white/10 bg-ink/55 p-4 shadow-[0_24px_80px_rgba(5,5,9,0.35)] backdrop-blur-xl sm:mt-8 sm:rounded-[1.75rem] sm:p-6 lg:mt-0 lg:min-w-[15rem]">
