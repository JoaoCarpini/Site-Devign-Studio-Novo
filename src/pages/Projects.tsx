    ...
    <>
      <section className="relative overflow-hidden pt-36 sm:pt-40">
        ...
        <div className="container-premium relative grid gap-12 pb-20 pt-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:pb-28">
          ...
          <Reveal delay={0.08} className="rounded-[2rem] border border-white/10 bg-white/[0.055] p-6 shadow-premium backdrop-blur-2xl">
      ...
      <section className="section-band pt-0">
        <div className="container-premium">
          <Reveal className="mb-14">
            <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(160deg,rgba(141,92,255,0.12),rgba(255,255,255,0.04)_42%,rgba(5,5,9,0.2))] p-8 shadow-premium backdrop-blur-2xl sm:p-10 lg:grid lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12">
              ...
              <div>
                ...
                <h2 className="mt-5 max-w-2xl text-3xl font-semibold leading-tight text-frost sm:text-4xl">
      ...
      <section className="pb-24">
        <div className="container-premium">
          <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[linear-gradient(135deg,rgba(141,92,255,0.24),rgba(255,255,255,0.06)_44%,rgba(77,212,198,0.1))] p-8 shadow-premium sm:p-12">
