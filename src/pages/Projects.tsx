...
export default function Projects() {
  ...
  const portfolioSignals = t('page.authority.signals', { returnObjects: true }) as string[];
    ...
    <>
      <section className="relative overflow-hidden pt-24 sm:pt-40">
        ...
        <div className="container-premium relative grid gap-6 pb-10 pt-4 sm:gap-12 sm:pb-20 sm:pt-8 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:pb-28">
          <Reveal>
            <span className="eyebrow mb-5 sm:mb-6">{t('page.eyebrow')}</span>
            <h1 className="heading-xl text-balance">{t('page.title')}</h1>
            <p className="body-lead mt-5 max-w-3xl sm:mt-7">{t('page.description')}</p>
            <ButtonLink to={routes.budget} className="mt-7 w-full sm:mt-9 sm:w-auto">
              {t('page.cta')}
          ...
          <Reveal delay={0.08} className="hidden rounded-[1.45rem] border border-white/10 bg-white/[0.055] p-5 shadow-premium sm:backdrop-blur-2xl lg:block lg:rounded-[2rem] lg:p-6">
            <div className="flex items-center justify-between gap-4">
              <div>
                <p className="text-sm font-semibold uppercase tracking-[0.22em] text-violet-400">{t('page.authority.eyebrow')}</p>
                <h2 className="mt-3 text-2xl font-semibold tracking-normal text-frost">{t('page.authority.title')}</h2>
              </div>
      ...
      <section className="section-band pt-0">
        <div className="container-premium">
          <Reveal className="mb-10 sm:mb-14">
            <div className="relative overflow-hidden rounded-[1.45rem] border border-white/10 bg-[linear-gradient(160deg,rgba(141,92,255,0.12),rgba(255,255,255,0.04)_42%,rgba(5,5,9,0.2))] p-4 shadow-premium sm:rounded-[2rem] sm:p-10 sm:backdrop-blur-2xl lg:grid lg:grid-cols-[1fr_auto] lg:items-center lg:gap-12">
              ...
              <div>
                ...
                <h2 className="mt-4 max-w-2xl text-xl font-semibold leading-tight text-frost sm:mt-5 sm:text-4xl">{t('page.deck.title')}</h2>
                <p className="mt-3 max-w-xl text-sm leading-7 text-mist sm:mt-4 sm:text-base sm:leading-8">{t('page.deck.description')}</p>
              </div>
          ...
          <SectionIntro
            eyebrow={t('page.detailed.eyebrow')}
            title={t('page.detailed.title')}
            text={t('page.detailed.description')}
          />
      ...
      <section className="pb-14 sm:pb-24">
        <div className="container-premium">
          <div className="relative overflow-hidden rounded-[1.45rem] border border-white/10 bg-[linear-gradient(135deg,rgba(141,92,255,0.24),rgba(255,255,255,0.06)_44%,rgba(77,212,198,0.1))] p-5 shadow-premium sm:rounded-[2rem] sm:p-12">
            ...
            <SectionIntro
              eyebrow={t('page.nextCase.eyebrow')}
              title={t('page.nextCase.title')}
              text={t('page.nextCase.description')}
            />
            <ButtonLink to={routes.budget} className="mt-7 w-full sm:mt-8 sm:w-auto">
              {t('page.nextCase.cta')}
              <ArrowRight className="h-4 w-4" />
            </ButtonLink>
          </div>
